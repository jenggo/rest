...
type OptionSet struct {
	InputOptions    vars.InputOptions
	ExchangeOptions vars.ExchangeOptions
	OutputOptions   vars.OutputOptions
}
...
func parsePretty(prettyFlag string, stdoutIsTerminal bool, outputOptions *vars.OutputOptions) error {
	switch prettyFlag {
	case "":
