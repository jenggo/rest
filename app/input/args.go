...
func ParseArgs(args []string, stdin io.Reader, options *vars.InputOptions) (*Input, error) {
...
func determinePreferredBodyType(options *vars.InputOptions) (BodyType, error) {
